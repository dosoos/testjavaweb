...
<html>
<head>
  <title>JSP - Hello yzhang8</title>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
</head>
<body>
<h1 style="width: 100%; text-align: center"><%= "Hello yzhang8!" %></h1>
<br/>
<%-- use chartjs draw three views pie, bar, line --%>
<%-- three canvas show inline how bootstrap row and col --%>
<div class="container">
  <div class="row">
    <div class="col-md-4">
      <canvas id="pieChart" width="30%"></canvas>
    </div>
    <div class="col-md-4">
      <canvas id="barChart" width="30%"></canvas>
    </div>
    <div class="col-md-4">
